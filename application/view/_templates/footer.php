<!-- Footer -->
    ...
    <!-- Materialize JS -->
    <script src="<?php echo Config::get('URL'); ?>js/materialize.js"></script>
    <!-- Plugin JS -->
    <script src="<?php echo Config::get('URL'); ?>js/pgwslider.js"></script>
    <script src="<?php echo Config::get('URL'); ?>js/jquery.touchSwipe.min.js"></script>
    <script src="<?php echo Config::get('URL'); ?>js/jquery.liquid-slider.js"></script>
    <script type='text/javascript' src='<?php echo Config::get('URL'); ?>js/camera.js'></script>
      <script type='text/javascript' src='<?php echo Config::get('URL'); ?>js/maps.js'></script>
    <!-- Custom Js -->
    <script src="<?php echo Config::get('URL'); ?>js/init.js"></script>
    <!--[if lt IE 9]>
